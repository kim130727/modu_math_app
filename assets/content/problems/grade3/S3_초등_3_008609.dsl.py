    ...
    return ProblemTemplate(
        ...
        slots=(
            ...
            RectSlot(
                id="slot.box",
                prompt="",
                x = 95, y = 75, width = 740, height = 80, fill="none",
                stroke="#F2A34A",
            ),
            TextSlot(
                id="slot.choice.left",
                prompt="",
                text = '㉠ 28 ÷ 2 = 14', style_role="question",
                x = 180, y = 125, font_size = 30, max_width = 750),
            TextSlot(
                id="slot.choice.right",
                prompt="",
                text = '㉡ 55 ÷ 5 = 15', style_role="question",
                x = 540, y = 125, font_size = 30, max_width = 750),
