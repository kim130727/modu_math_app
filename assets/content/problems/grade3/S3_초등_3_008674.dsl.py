...
def _base_circle_arc(id_: str, *, cx: float, cy: float, r: float = 76.0) -> PathSlot:
    return PathSlot(
        id=id_,
        prompt="",
        d=f"M {cx} {cy - r} A {r} {r} 0 1 0 {cx + r} {cy}",
        stroke=BLACK,
        stroke_width=2.1,
    )
...
def _correct_completion_arc(id_: str, *, cx: float, cy: float, r: float = 76.0) -> PathSlot:
    return PathSlot(
        id=id_,
        prompt="",
        d=f"M {cx} {cy - r} A {r} {r} 0 0 1 {cx + r} {cy}",
        stroke=RED,
        stroke_width=2.1,
    )
...
def _corner_completion_arc(id_: str, *, cx: float, cy: float, r: float = 76.0) -> PathSlot:
    ...
    return PathSlot(
        id=id_,
        prompt="",
        d=f"M {corner_cx - r} {corner_cy} A {r} {r} 0 0 0 {corner_cx} {corner_cy + r}",
        stroke=RED,
        stroke_width=2.1,
    )
...
def build_problem_template() -> ProblemTemplate:
    return ProblemTemplate(
        ...
        canvas=Canvas(width=926.0, height=410.0, coordinate_mode="logical"),
        regions=(
            Region(
                id="region.header",
                role="stem",
            ...
            Region(
                ...
                role="diagram",
                flow="absolute",
                slot_ids=("slot.ref.square", "slot.ref.arc", "slot.ref.center"),
            ),
            Region(
                id="region.choices",
                role="choices",
        ...
        slots=(
            ...
            _square("slot.ref.square", x=407.0, y=48.0),
            _base_circle_arc("slot.ref.arc", cx=483.0, cy=124.0),
            _center_dot("slot.ref.center", cx=483.0, cy=124.0),
            _square("slot.choice.left.square", x=138.0, y=226.0),
            _base_circle_arc("slot.choice.left.base", cx=214.0, cy=302.0),
            _corner_completion_arc("slot.choice.left.red", cx=214.0, cy=302.0),
            _center_dot("slot.choice.left.center", cx=214.0, cy=302.0),
            _square("slot.choice.middle.square", x=407.0, y=226.0),
            _base_circle_arc("slot.choice.middle.base", cx=483.0, cy=302.0),
            LineSlot(
                id="slot.choice.middle.red",
                prompt="",
                x1=483.0,
                y1=226.0,
                x2=559.0,
            ...
            _center_dot("slot.choice.middle.center", cx=483.0, cy=302.0),
